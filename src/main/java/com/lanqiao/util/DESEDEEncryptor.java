...
public class DESEDEEncryptor extends Coder
{
	...
	public static final String DesKey = "9Svutulw2l0Vr5qv2t2P1eusdeZIQyWemugimJVP4qOecGUwluskcseF";
	...
	public static byte[] base64De(String key)
	{
		...
		{
			Base64 b = new Base64();
			return b.decode(key.getBytes("UTF-8"));
		} catch (Exception se)
		{
			return null;
...
//		System.out.println ("key size:"+DesKey.getBytes().length);
//		
//		String src="123456789-1234567890";
...
//		System.out.println ("解密后("+plainsrc.length()+"):"+plainsrc);
		...
		String hexval = hexEncode("chen陈宝吉");
		System.out.println(hexval);
		System.out.println(hexDecode(hexval));
