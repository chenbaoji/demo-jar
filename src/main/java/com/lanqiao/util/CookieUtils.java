...
public class CookieUtils {
	...
	public static void setCookieOnce(HttpServletResponse response,String domain, String name, String value) {
		try {
		StringBuffer buff = new StringBuffer(1024);
		buff.append(name+"="+URLEncoder.encode(value, "utf-8"));
		buff.append("; SameSite=Lax;");
		buff.append("; Domain="+domain+";");
		buff.append(" Path=/");
		
		response.setHeader("Set-Cookie",buff.toString());
